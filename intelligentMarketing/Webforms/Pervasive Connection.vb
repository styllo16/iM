...
Public Class Pervasive_Connection
    Inherits Form
    ...
    Public Sub New()
        ...
        Me.SetDesktopBounds(0, 0, 800, 700)

        ' Load the user's home page.
        webBrowser1.Navigate(URL_OutForms)
    ...
    Private Sub Pervasive_Connection_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
