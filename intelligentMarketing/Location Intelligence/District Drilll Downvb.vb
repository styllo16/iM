...
Imports System.Net
Public Class District_Drilll_Downvb


    Private Sub District_Drilll_Downvb(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Load_Regional_Drill_Down_Data_Into_Drill_Down_Datagrid(Selected_District_for_Drill_Down)
    End Sub
    Sub Load_Regional_Drill_Down_Data_Into_Drill_Down_Datagrid(ByVal District As String)
        Dim i As Integer
        ...
        Dim queryString As String = _
           "SELECT " & Customer_Code_Field & ", " & Customer_Field_Name & ", " & Customer_Contact_Field1 & ", " & District_Field & ", " & Customer_Location_Field & " from " & Customer_Table_Name & " where " & District_Field & " like '%" & Selected_District_for_Drill_Down & "%' or " & District_Field & " like '%" & Selected_District_Captial_for_Drill_Down & "%'"
    ...
    Private Sub dg_Regional_Drill_Down_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dg_Regional_Drill_Down.CellContentClick

    End Sub

    Private Sub dg_Regional_Drill_Down_CellContentClick_1(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dg_Regional_Drill_Down.CellContentClick

    End Sub

    Private Sub District_Drilll_Downvb_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

    End Sub

    Private Sub District_Drilll_Downvb_Load_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
